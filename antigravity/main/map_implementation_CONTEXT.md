---
title: 🗺️ 3Dマップ機能 技術実装詳細書 (v0.7.0)
tags: [main, context, map, 3d]
status: active
...
> [!WARNING]
> 本ドキュメントは古い「V1エディタ (`main/map_editor/`)」の仕様を記述したものです。
> 最新の「V2エディタ (`main/map_editor_v2/`)」の仕様については、[[map-3d_CONTEXT]] を参照してください。
