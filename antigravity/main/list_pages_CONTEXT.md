...
- **リストデザイン**:
  ...
  - `stage-list.html` / `index.html`: ステージ発表カード（`.list-event-card`）はパディング `8px 12px`（スマホ `6px 10px`）、時間フォント `0.88rem`、タイトル `0.92rem` にスリム化し、詳細リンクボタンのラベルを「詳細」に統一（2026-09-02 最適化）。
