...
**提供口（ていきょうぐち）**: 完成した商品を来場者に手渡すカウンタ。`presenter.html` を操作するスタッフが配置され、AirPay 手動 QR 決済の金額照合と商品引渡を担当する。
...
| サービス                  | 用途                   | 連携方式                            |
| ------------------------- | ---------------------- | ----------------------------------- |
| AirPay                    | 来場者からの決済受領   | 手動 QR、API 連携なし               |
...
- AirPay 加盟店向けサイト: https://AirPay.wallet.auone.jp/merchant/
